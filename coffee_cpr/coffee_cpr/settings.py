...
ALLOWED_HOSTS = ['coffee-cpr-d6756e17eee2.herokuapp.com', 'localhost', '127.0.0.1']
...
# Modern Django WhiteNoise Configuration (Prevents boot crashes when static files aren't collected)
STORAGES = {
    "default": {
